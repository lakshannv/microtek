...
%>
<nav class="navbar navbar-light navbar-expand-xl fixed-top main-nav">
    <div class="container-fluid">
        <a class="navbar-brand d-flex align-items-center" href="#"><img class="nav-logo" src="assets/img/Logo.png" />Admin Panel</a>
